		...
		return(
			<footer className="footer">
				<div className="footer__items">
					...
					<p className="footer__text"> &copy; 2017 </p>
				</div>

				<div className="footer__items">
					<p className="footer__text">¿Dónde estamos? </p>
				...
				<div className="footer__items">
					<div className="footer__questions">
						<a className="footer__link footer__text" href="formulario.html" target="_blank">¿Qué tal lo hemos hecho?</a>
